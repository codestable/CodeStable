# Results — cs-refactor-001

- skill_under_test: `cs-refactor`
- cells: 1（variant×harness×model）× k=1
- evidence_pointer: `artifacts/analysis/exp-cs-refactor-001-results.json`
...
| baseline | recall_judge | 0.25 [soft: mean over n=8] |
